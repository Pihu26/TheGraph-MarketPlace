...
import {  ItemCanceled, ItemListed,ActiveItem, ItemBought} from "../generated/schema"
...
export function getIdFromEventParams(tokenId:BigInt,nftAddress:Address) :string {
